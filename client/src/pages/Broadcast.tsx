...
export default function Broadcast() {
    ...
    useEffect(() => {
        ...
        if (loadType === 'PICKUP') {
            ...
            setShowBroadcastModal(true);
            navigate(`${basePath}/broadcast`, { replace: true });
        ...
        <div className="p-6 max-w-full mx-auto space-y-6">
            <div className="flex justify-between items-center">
                ...
                <div className="bg-gray-100 p-1 rounded-lg flex">
                    <button
                        onClick={() => navigate(`${basePath}/broadcast/connection`)}
                    ...
                    <button
                        onClick={() => navigate(`${basePath}/broadcast/templates`)}
                    ...
                    <button
                        onClick={() => navigate(`${basePath}/broadcast/campaigns`)}
