import { type WASocket, type ConnectionState, type proto } from '@whiskeysockets/baileys';
import { Boom } from '@hapi/boom';
declare class WhatsAppService {
    sock: WASocket | null;
    connectionStatus: 'CONNECTED' | 'DISCONNECTED' | 'CONNECTING' | 'QR';
    qr: string | null;
    private authDir;
    constructor();
    init(): Promise<{
    ...
    sendMessage(to: string, text: string): Promise<import("@whiskeysockets/baileys").WAMessage | undefined>;
    logout(): Promise<void>;
}
